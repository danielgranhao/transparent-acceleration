...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fpdsp_block_160/sim/fp_mult_altera_fpdsp_block_160_4mzrtia.sv" -work altera_fpdsp_block_160
