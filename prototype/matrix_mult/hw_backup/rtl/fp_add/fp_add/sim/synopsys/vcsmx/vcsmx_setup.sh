...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fpdsp_block_160/sim/fp_add_altera_fpdsp_block_160_o5ob76q.sv" -work altera_fpdsp_block_160
