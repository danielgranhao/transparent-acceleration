...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_fpdsp_block_160/sim/fp_add_altera_fpdsp_block_160_o5ob76q.sv" -work altera_fpdsp_block_160 -cdslib ./cds_libs/altera_fpdsp_block_160.cds.lib
