...
# # End of template
# ----------------------------------------
# If fp_mult_accumulate is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.0 211 linux 2019.05.21.14:30:23
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp_mult_accumulate"
}
...
ensure_lib                        ./libraries/altera_fpdsp_block_160/
vmap       altera_fpdsp_block_160 ./libraries/altera_fpdsp_block_160/
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fpdsp_block_160/sim/fp_mult_accumulate_altera_fpdsp_block_160_pjjncdi.sv" -work altera_fpdsp_block_160
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/fp_mult_accumulate.v"                                                                                           
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_fpdsp_block_160 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_fpdsp_block_160 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
