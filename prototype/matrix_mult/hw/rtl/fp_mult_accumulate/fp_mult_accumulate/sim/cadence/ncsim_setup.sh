...
TOP_LEVEL_NAME="fp_mult_accumulate"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/altera_fpdsp_block_160/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_fpdsp_block_160/sim/fp_mult_accumulate_altera_fpdsp_block_160_pjjncdi.sv" -work altera_fpdsp_block_160 -cdslib ./cds_libs/altera_fpdsp_block_160.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_mult_accumulate.v"                                                                                                                                             
fi
