...
# # End of template
# ----------------------------------------
# If fp_mult_reg is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.0 211 linux 2019.05.20.17:40:31
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp_mult_reg"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fpdsp_block_160/sim/fp_mult_reg_altera_fpdsp_block_160_e4wbm5a.sv" -work altera_fpdsp_block_160
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/fp_mult_reg.v"                                                                                           
}
