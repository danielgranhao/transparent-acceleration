...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_fpdsp_block_160/sim/fp_mult_reg_altera_fpdsp_block_160_e4wbm5a.sv" -work altera_fpdsp_block_160
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_mult_reg.v"                                                                                           
}
