...
#ifndef __VCS_IMPORT_DPI_STUB_rd_memline_req_dex
#define __VCS_IMPORT_DPI_STUB_rd_memline_req_dex
__attribute__((weak)) void rd_memline_req_dex(/* INOUT */cci_pkt *A_1)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INOUT */cci_pkt *A_1) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_stub_initialized_ = 1;
        _vcs_dpi_fp_ = (void (*)(cci_pkt* A_1)) dlsym(RTLD_NEXT, "rd_memline_req_dex");
    }
    if (_vcs_dpi_fp_) {
        _vcs_dpi_fp_(A_1);
    } else {
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "rd_memline_req_dex");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_rd_memline_req_dex */

#ifndef __VCS_IMPORT_DPI_STUB_rd_memline_rsp_dex
#define __VCS_IMPORT_DPI_STUB_rd_memline_rsp_dex
__attribute__((weak)) void rd_memline_rsp_dex(/* INOUT */cci_pkt *A_1)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INOUT */cci_pkt *A_1) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_stub_initialized_ = 1;
        _vcs_dpi_fp_ = (void (*)(cci_pkt* A_1)) dlsym(RTLD_NEXT, "rd_memline_rsp_dex");
    }
    if (_vcs_dpi_fp_) {
        _vcs_dpi_fp_(A_1);
    } else {
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "rd_memline_rsp_dex");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_rd_memline_rsp_dex */

#ifndef __VCS_IMPORT_DPI_STUB_wr_memline_req_dex
#define __VCS_IMPORT_DPI_STUB_wr_memline_req_dex
__attribute__((weak)) void wr_memline_req_dex(/* INOUT */cci_pkt *A_1)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INOUT */cci_pkt *A_1) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_stub_initialized_ = 1;
        _vcs_dpi_fp_ = (void (*)(cci_pkt* A_1)) dlsym(RTLD_NEXT, "wr_memline_req_dex");
    }
    if (_vcs_dpi_fp_) {
        _vcs_dpi_fp_(A_1);
    } else {
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "wr_memline_req_dex");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_wr_memline_req_dex */

#ifndef __VCS_IMPORT_DPI_STUB_wr_memline_rsp_dex
#define __VCS_IMPORT_DPI_STUB_wr_memline_rsp_dex
__attribute__((weak)) void wr_memline_rsp_dex(/* INOUT */cci_pkt *A_1)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INOUT */cci_pkt *A_1) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_stub_initialized_ = 1;
        _vcs_dpi_fp_ = (void (*)(cci_pkt* A_1)) dlsym(RTLD_NEXT, "wr_memline_rsp_dex");
    }
    if (_vcs_dpi_fp_) {
        _vcs_dpi_fp_(A_1);
    } else {
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "wr_memline_rsp_dex");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_wr_memline_rsp_dex */
